 ...
 * class that must already be loaded with the properties key/value pairs required for this job.
 * A file is created for output with the name &lt;JobProfileName&gt;&lt;FileNameDate&gt;.txt.
 * Output is generated by calling the println(String s) method of this class, which writes to
 * the file and simultaneously to stdOut.
 *
 * @author Lee Rhodes
 */
public class Job {
